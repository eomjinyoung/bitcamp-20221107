...
- 최종 프로젝트
  ...
  - 수행: 최종 프로젝트 발표(팀당 20분)
    ...
    - 최종 발표(4/21,금,13:00)
      - 여긴좋아-여행커뮤니티(서길원, 이성민, 이명준, 조준호)(1)
      - 요긴한강-한강관광커뮤니티(심우준, 양창덕, 조희성)(2)
      - 응급실-비대면 의료 진료 서비스(이준영, 조승현, 차민주, 김현우, 이예찬)(3)
      - 산들산들-등산정보서비스(이건형, 서영훈, 박경한, 안진수, 김종현)(4)
      - ARTIFY-AI그림생성서비스(신지윤, 전태산, 오병현, 한대호, 윤종광)(5)
